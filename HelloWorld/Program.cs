...
namespace HelloWorld
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //this is shortcut(comment/uncomment - VS Standard Toolbar)
            ...
            //Console.WriteLine(ageOne + ageTwo);//Addition
            //Console.WriteLine(heightOne - heightTwo);//Substraction
            //Console.WriteLine(weightOne * weightTwo);//Multiplication
            //Console.WriteLine(isGodLikeOne);//Bool
            //Console.WriteLine(genderMale);//Char
            ...
            //Console.WriteLine("What is the distance to Nurceria?");
            ...
            //if ((cityThreeDistance <= 125) && ((cityThreeDistance < cityTwoDistance) && (cityThreeDistance < cityOneDistance)))
            //{
            ...
            //Console.WriteLine(elements[1]); //am
